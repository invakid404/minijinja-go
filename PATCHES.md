...
**The log is empty. As of `v2.16.0-baml.0` this fork has no semantic delta over
`mitsuhiko/minijinja@b9afca` (`minijinja-go/v2.16.0`).** The only differences
are the two mechanical transforms described in [UPSTREAM.md](UPSTREAM.md), which
`scripts/verify-seed.sh` proves.
